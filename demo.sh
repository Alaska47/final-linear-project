...
python lin_proj.py demo.png demo_1_IDENTITY.png identity 1
python lin_proj.py demo.png demo_2_SHARPEN.png sharpen 1
python lin_proj.py demo.png demo_3_BLUR.png blur 3
python lin_proj.py demo.png demo_4_BOTTOM_EDGE.png bottom_edge 1
